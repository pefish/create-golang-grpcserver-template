...
func request_HelloWorld_GetResult_0(ctx context.Context, marshaler runtime.Marshaler, client HelloWorldClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_HelloWorld_GetResult_0(ctx context.Context, marshaler runtime.Marshaler, server HelloWorldServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetResultRequest
	var metadata runtime.ServerMetadata
...
func RegisterHelloWorldHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HelloWorldServer) error {
	...
	mux.Handle("POST", pattern_HelloWorld_GetResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_HelloWorld_GetResult_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_HelloWorld_GetResult_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterHelloWorldHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloWorldClient) error {
	...
	mux.Handle("POST", pattern_HelloWorld_GetResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HelloWorld_GetResult_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_HelloWorld_GetResult_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "get-result"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_HelloWorld_GetResult_0 = runtime.ForwardResponseMessage
)
